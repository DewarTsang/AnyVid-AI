<template>
  <header class="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-border-light">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
      <a href="/" class="flex items-center gap-3" title="AnyVid AI - 免费在线万能视频下载器">
        <div class="w-9 h-9 rounded-xl bg-gradient-to-br from-primary to-blue-600 flex items-center justify-center shadow-sm" role="img" aria-label="AnyVid AI Logo">
        ...
        <span class="text-lg font-semibold text-text-primary tracking-tight">AnyVid AI</span>
      ...
      <nav class="hidden md:flex items-center gap-6 text-sm text-text-secondary" aria-label="主导航">
        <a href="#features" class="hover:text-primary transition-colors" title="查看AnyVid AI功能特性">功能特性</a>
        <a href="#how-to-use" class="hover:text-primary transition-colors" title="了解如何使用AnyVid AI下载视频">使用教程</a>
        <a href="#comparison" class="hover:text-primary transition-colors" title="AnyVid AI与其他工具对比">工具对比</a>
        <a href="#pricing" class="hover:text-primary transition-colors" title="查看AnyVid AI套餐价格">套餐价格</a>
      </nav>
