...
class Settings(BaseSettings):
    ...
    TITLE: str = "🎉 AnyVid AI 🎉 "  # 文档标题
    VERSION: str = "0.1.0"  # 版本号
    DESCRIPTION: str = "基于 yt-dlp 的万能视频下载服务，支持 1800+ 平台"  # 文档描述
    ...
    STRIPE_WEBHOOK_SECRET: str = "whsec_your_webhook_signing_secret"
    STRIPE_PRICE_ID_MONTHLY: str = "price_your_monthly_price_id"
